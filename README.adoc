...
=== Peer of Flight-ssg
While `flight-ssg` leverages the Arrow paradigm, `january-ssg` provides a familiar imperative structure (loops, conditionals) that remains strictly reversible. It serves as the "structured" anchor for the reversible tier of the ecosystem.
